...
public class CommonFunctions {
	...
	@Value("${InterBankFTNotificationMailContacts}")
	private String InterBankFTNotificationMailContacts;

	@Value("${suspenseAccountNo}")
	private String suspenseAccountNo;
