package backendrestapi.security;
...
public class SignatureGenerator {
    ...
    public static void main(String[] args){
    	...
    	String username = "COMPULINKS_test123#";
    	String password = "C2wdB\"6>vKxLW\"LK";
    	String TransId = "";
    	String action = "";
    	String apiKey= "-4&tkM+_GLVTK:S56fg`VM892732";
    	String signature = generateSignature( username, password, TransId, action, apiKey);
