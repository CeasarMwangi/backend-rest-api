...
import backendrestapi.repositories.PrivilegeRepository;
import backendrestapi.repositories.RoleRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		user.setUsername("user1" +(int) (Math.random() * (1000 - 1)) + 1 +(int) (Math.random() * (100 - 1)) + 1);
